 ...
 */
package utybo.branchingstorytree.swing.ext;

// THIS CLASS IS TAKEN FROM THE MAVEN-ARTIFACT LIBRARY
...
public class ComparableVersion implements Comparable<ComparableVersion>
{
    ...
    {
        private static final List<String> QUALIFIERS = Arrays.asList("alpha", "beta", "milestone",
                "rc", "snapshot", "", "sp");
