...
import zrrk.bst.openbst.utils.BezierEase;
...
public class Splashscreen extends JFrame
{
    ...
    private JAlphaPanel panLogo, panZrrk, panBlue;
    ...
    public Splashscreen(BufferedImage splashImg)
    {
        ...
        try
        {
            setIconImage(ImageIO.read(Splashscreen.class
                    .getResourceAsStream("/zrrk/bst/openbst/logos/Logo48.png")));
        }
        catch(IOException e)
        {
            OpenBST.LOG.error(e);
        ...
        if(splashImg != null)
        {
            ...
            layers.add(panBackground, Integer.valueOf(0));
        }

        panBlue = new JAlphaPanel();
        panBlue.setBackground(OpenBSTGUI.OPENBST_BLUE);
        panBlue.setBounds($(0, 0, 400, 120));
        layers.add(panBlue, Integer.valueOf(1));

        panLogo = new JAlphaPanel();
        ...
        try
        {
            lblLogo.setIcon(new ImageIcon(ImageIO.read(Splashscreen.class
                    .getResourceAsStream("/zrrk/bst/openbst/logos/FullLogoWhite"
        ...
        layers.add(panLogo, Integer.valueOf(2));
        ...
        layers.add(lblText, Integer.valueOf(10));

        panZrrk = new JAlphaPanel();
        panZrrk.setBackground(new Color(0, 0, 0, 0));
        lblZrrk = new JLabel();
        try
        {
            lblZrrk.setIcon(new ImageIcon(ImageIO.read(Splashscreen.class
                    .getResourceAsStream("/zrrk/bst/openbst/logos/minizrrk"
        ...
        layers.add(panZrrk, Integer.valueOf(11));
